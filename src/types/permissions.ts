...
export function getDefaultPermissionTemplates(): Array<Pick<PermissionTemplate, 'name' | 'description' | 'baseRole' | 'permissions'>> {
  return [
    ...
    },
    {
      ...
      permissions: {
        canView: [RESOURCES.ALL],
        canCreate: [RESOURCES.SALES, RESOURCES.PRODUCTS, RESOURCES.CUSTOMERS, RESOURCES.ORDERS, RESOURCES.EXPENSES, RESOURCES.PRODUCTS_STOCKS, RESOURCES.PRODUCTS_CATEGORIES, RESOURCES.SHOPS, RESOURCES.WAREHOUSE],
        canEdit: [RESOURCES.SALES, RESOURCES.PRODUCTS, RESOURCES.CUSTOMERS, RESOURCES.ORDERS, RESOURCES.EXPENSES, RESOURCES.PRODUCTS_STOCKS, RESOURCES.PRODUCTS_CATEGORIES, RESOURCES.SHOPS, RESOURCES.WAREHOUSE],
    ...
    },
    {
      ...
      permissions: {
        canView: [RESOURCES.PERMISSIONS, RESOURCES.HUMAN_RESOURCES, RESOURCES.SHOPS, RESOURCES.WAREHOUSE, RESOURCES.DASHBOARD],
        canCreate: [RESOURCES.PERMISSIONS, RESOURCES.HUMAN_RESOURCES, RESOURCES.SHOPS, RESOURCES.WAREHOUSE],
        canEdit: [RESOURCES.PERMISSIONS, RESOURCES.HUMAN_RESOURCES, RESOURCES.SHOPS, RESOURCES.WAREHOUSE],
        canDelete: [],
        canManageEmployees: [],
      }
    },
