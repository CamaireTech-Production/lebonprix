...
import { Play, Pause, Volume2, VolumeX, Calendar, Clock, MapPin, Star, Heart, Share2 } from 'lucide-react';
...
const InlineAdSection: React.FC<InlineAdSectionProps> = ({ ad, restaurant, onReserve }) => {
...
export default InlineAdSection;
